...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'backend.services.ocr_reconcile_service_v3', 'backend.services.senior_toolbox_service_v3',
        'backend.api.fund_fee_v3', 'backend.api.decision_review_v3', 'backend.api.senior_toolbox_v3',
