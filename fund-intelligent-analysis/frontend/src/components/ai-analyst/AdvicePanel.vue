...
const marketViewText = computed(() => marketViewLabel(latestAdvice.value?.market_view))
const marketViewType = computed(() => marketViewTagType(latestAdvice.value?.market_view))
